                                ...
                                <div class="card-header">
                                    <div class="row align-items-center">
                                        <div class="col-md-6">
                                            ...
                                            <small class="text-muted">Placed on {{ $order->created_at->format('M j, Y g:i A') }}</small>
                                        </div>
                                ...
                                <div class="card-body">
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-md-6 text-md-end">
                                            ...
                                            <div class="mb-2">
                                                <span>Tax:</span>
                                                <span class="ms-2">${{ number_format($order->tax_amount, 2) }}</span>
                                            </div>
                                            <div class="mb-2">
                                                <span>Shipping:</span>
                                                <span class="ms-2">${{ number_format($order->shipping_amount, 2) }}</span>
                                            </div>
                                            <div class="mb-2">
                                                <strong>Total:</strong>
                                                <strong class="ms-2 text-primary">${{ number_format($order->total_amount, 2) }}</strong>
                                            </div>
                                        </div>
                                    </div>
                                    ...
                                    <div class="text-end mt-3">
                                        ...
                                        @if($order->payment_status === 'pending' && $order->payment_method === 'bank_transfer')
                                            <button class="btn btn-outline-info btn-sm ms-2" onclick="showBankDetails()">
